    ...
    if current_user.tenant_id == 3:
        ...
        return [
            ...
            DeviceTypeResponse(
                ...
                name="TCP_HEX",
                protocol="TCP_HEX",
                description="TCP device with hexadecimal payload",
                schema_definition={"type": "object", "additionalProperties": True},
            ),
            DeviceTypeResponse(
                id=5,
                name="NB-IoT",
                protocol="NB-IoT",
                description="NB-IoT/CAT-M1 device",
                schema_definition={"type": "object", "additionalProperties": True},
            ),
            DeviceTypeResponse(
                id=6,
            ...
            DeviceTypeResponse(
                ...
                name="DALI",
                protocol="DALI",
                description="DALI (Digital Addressable Lighting Interface) device",
                schema_definition={"type": "object", "additionalProperties": True},
            ),
            DeviceTypeResponse(
                id=8,
            ...
            DeviceTypeResponse(
                ...
                name="CoAP",
                protocol="CoAP",
                description="CoAP (Constrained Application Protocol) device",
                schema_definition={"type": "object", "additionalProperties": True},
            ),
            DeviceTypeResponse(
                id=10,
