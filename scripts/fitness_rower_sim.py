#!/usr/bin/env python3
"""
Smart Fitness Equipment (Rower) MQTT telemetry simulator.

Publishes JSON telemetry for a fitness rower device.
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "fitness_rower_02")
