#!/usr/bin/env python3
"""
E-Scooter MQTT telemetry simulator for ES-RP-2.
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "ES-RP-2")
...
# Location (Murabba, Riyadh coordinates) - ES-RP-2
LAT = float(os.environ.get("LAT", "24.6450"))
LNG = float(os.environ.get("LNG", "46.7050"))
