#!/usr/bin/env python3
"""
Smart Bin MQTT telemetry simulator for SB-RP-2.
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "SB-RP-2")
BIN_ID = os.environ.get("BIN_ID", "sb_rp_2")
...
# Location (Murabba, Riyadh coordinates) - SB-RP-2
    ...
    try:
        while True:
            ...
            if status == mqtt.MQTT_ERR_SUCCESS:
                ...
                print(f"  General Waste: {payload['fillLevel']['generalWaste']}%, Battery: {payload['battery']}%, Fire Alert: {payload['fireAlert']}")
            else:
