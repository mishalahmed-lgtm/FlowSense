#!/usr/bin/env python3
"""
Smart Recycling Kiosk MQTT telemetry simulator for SR-RP-1.

Publishes JSON telemetry matching the recycle_kiosk_01 format.
"""
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "SR-RP-1")
...
def build_payload() -> dict:
    """Build a telemetry payload matching recycle_kiosk_01 format."""
    now = datetime.utcnow()
