#!/usr/bin/env python3
"""
Ambient Noise Sensor MQTT telemetry simulator for AN-RP-1.

Publishes JSON telemetry matching the noise_sensor_08 format.
"""
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "AN-RP-1")
...
def build_payload() -> dict:
    """Build a telemetry payload matching noise_sensor_08 format."""
    now = datetime.utcnow()
