#!/usr/bin/env python3
"""
Adaptive Pathway Lighting MQTT telemetry simulator.

Publishes JSON telemetry for a pathway lighting device.
...
# Configuration
DEVICE_ID = os.environ.get("DEVICE_ID", "lightpole_12")
