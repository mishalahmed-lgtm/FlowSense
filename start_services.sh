...
echo "InfluxDB: http://localhost:8086 (host) -> 8086 (container)"
echo ""
echo "To test the new features, use the helper scripts in the 'scripts/' directory,"
echo "for example: python3 scripts/test_new_features.py"
